...
<div align="center">
  ...
  <img src="Assets/theme-aurora.png" alt="极光主题" width="45%">
</div>

*四种主题：深色、浅色、蓝色科技、极光（赛博朋克/蒸汽波风格）*
...
### 🎨 现代 UI/UX
- 四种主题：深色 / 浅色 / 蓝色科技 / 极光（赛博朋克/蒸汽波）
- **极光主题特性** ✨ 全新：
  - 赛博朋克/蒸汽波美学风格，深紫色与青色渐变
  - 彩色辉光阴影（紫色/粉色）而非传统黑色阴影
  - 微交互动画：悬停缩放（按钮）、悬停位移（卡片）
  - 图标盒呼吸动画，辉光效果脉动
  - 现代玻璃拟态，增强深度与层次感
- 语义化状态颜色系统 ✨ v1.1
...
## 🎨 极光主题详情
极光主题带来现代赛博朋克/蒸汽波美学：
- **调色板**：深色背景 (#0D0221) 搭配高饱和度紫色 (#A855F7) 和青色 (#06B6D4) 点缀
- **辉光效果**：彩色投影阴影（紫色/粉色）营造霓虹辉光效果
- **微交互动画**：
  - 按钮悬停时缩放至 1.05 倍，平滑缓动（150ms）
  - 导航项悬停时向右滑动 3 像素
  - 仪表板卡片悬停时上浮 5 像素，使用故事板动画
  - 图标盒呼吸辉光动画（2 秒循环，正弦缓动）
- **排版**：增强文字渲染，紫色次要文本 (#A78BFA)
- **适用场景**：深色模式爱好者、创意专业人士、现代科技应用
...
## 📝 更新日志
### v1.4 - 2024
- **极光主题**：全新赛博朋克/蒸汽波主题，带微交互动画
  - 彩色辉光阴影（紫色/粉色）增强深度与现代感
  - 按钮缩放动画（悬停时 1.05 倍）
  - 卡片位移动画（悬停时上浮 5 像素）
  - 图标盒呼吸辉光动画
  - 深紫色到青色的渐变背景
